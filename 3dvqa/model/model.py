...
if __name__ == "__main__":
    ...
    train_loader = torch.utils.data.DataLoader(
                   MyDataLoader(
                   im_dict,max_len, complete_list, ModelID1, QuestionList, Correct_Answers, embeddings_dict, method, mode='train'
                   ),
    ...
    val_loader = torch.utils.data.DataLoader(
                 MyDataLoader(
                 im_dict,max_len, complete_list, ModelID1_val, QuestionList_val, Correct_Answers_val, embeddings_dict, method, mode='test'
                 ),
